    ...
    else
    {
        constexpr_for<0, VelocitySet::Q()>(
            [&](const auto Q) noexcept
            {
                ...
                else if constexpr (cz == -1)
                {
                    uz -= fi;
                    mzz += fi;
                }

                if constexpr (cx * cy == 1)
                {
                    mxy += fi;
                }
                else if constexpr (cx * cy == -1)
                {
                    mxy -= fi;
                }

                if constexpr (cx * cz == 1)
                {
                    mxz += fi;
                }
                else if constexpr (cx * cz == -1)
                {
                    mxz -= fi;
                }

                if constexpr (cy * cz == 1)
                {
                    myz += fi;
                }
                else if constexpr (cy * cz == -1)
                {
                    myz -= fi;
                }
            });
